...
class Profile(models.Model):
    ...
    COL=(('Christ University Central Campus','Christ University Central Campus'),('Christ University Kengeri Campus','Christ University Kengeri Campus')) #change college names
    user =models.OneToOneField(User, on_delete=models.CASCADE,primary_key=True)
    collegename=models.CharField(max_length=50,choices=COL,blank=False)
    ...
    CB=(('MCA',"MCA"),('MSAIM',"MSAIM"),('ComputerScience',"ComputerScience"),('InformationScience',"InformationScience"),('Electronics and Communication',"Electronics and Communication"),('Mechanical',"Mechanical"))
    Branch=models.CharField(choices=CB,max_length=50,default='ComputerScience')
    def __str__(self):
